...
set(RP2XXX_BOARD seeed_xiao_rp2350)

# The vendored pico-sdk C headers use static_assert, which needs C11.
set(CMAKE_C_STANDARD 11)

set(_XIAO_RP2350_ARCH_FLAGS "-mcpu=cortex-m33 -mthumb -mfloat-abi=hard \
-mfpu=fpv5-sp-d16")

set(CMAKE_ASM_FLAGS "${_XIAO_RP2350_ARCH_FLAGS} -g -O3")

set(_XIAO_RP2350_COMMON_FLAGS
    "${_XIAO_RP2350_ARCH_FLAGS} -g -O3 -fshort-enums \
...
# hosted-only guard.
set(CMAKE_C_FLAGS "${_XIAO_RP2350_COMMON_FLAGS} -ffreestanding")
set(CMAKE_CXX_FLAGS "${_XIAO_RP2350_COMMON_FLAGS} -fno-rtti -fno-exceptions \

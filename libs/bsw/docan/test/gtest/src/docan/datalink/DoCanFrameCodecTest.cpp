...
TEST(DoCanFrameCodecTest, testDecodeFirstFramesWithEscapeSeqAndShortMinFrame)
{
    ...
    uint8_t consecutiveFrameDataSize;
    {
        ...
        ::etl::span<uint8_t const> escapeSeqPayload = {{0xab, 0x10, 0x00, 0x12, 0x34, 0x56}};
        ::etl::span<uint8_t const> normalPayload    = {{0xab, 0x11, 0x23, 0xAB, 0xCD, 0xEF}};
        EXPECT_EQ(
        ...
        EXPECT_TRUE(::etl::equal(normalPayload.subspan(3U), data));
    }
    {
...
TEST(DoCanFrameCodecTest, testEncodeDataFrame)
{
    ...
    uint8_t consumedDataSize;
    {
        ...
        ::etl::span<uint8_t const> data{{0x12, 0x34, 0x78}};
        ::etl::span<uint8_t const> expected{{0xdc, 0x03, 0x12, 0x34, 0x78}};
        ::etl::span<uint8_t> payload(frame);
        EXPECT_EQ(CodecResult::OK, cut.encodeDataFrame(payload, data, 0U, 0U, consumedDataSize));
        EXPECT_TRUE(::etl::equal(expected, payload));
    ...
    }
    {
        ...
        {
            // first frame
            ::etl::span<uint8_t const> expected{{0xdc, 0x10, 0x07, 0x12, 0x34, 0x56, 0x78, 0x9a}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame
            ::etl::span<uint8_t const> expected{{0xdc, 0x21, 0xbc, 0xde}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
    ...
    }
    {
        ...
        {
            // first frame
            ::etl::span<uint8_t const> expected{{0xdc, 0x10, 0x07, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 1
            ::etl::span<uint8_t const> expected{{0xdc, 0x21, 0x12}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 2
            ::etl::span<uint8_t const> expected{{0xdc, 0x22, 0x34}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 3
            ::etl::span<uint8_t const> expected{{0xdc, 0x23, 0x56}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 4
            ::etl::span<uint8_t const> expected{{0xdc, 0x24, 0x78}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 5
            ::etl::span<uint8_t const> expected{{0xdc, 0x25, 0x9a}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 6
            ::etl::span<uint8_t const> expected{{0xdc, 0x26, 0xbc}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
        ...
        {
            // consecutive frame 7
            ::etl::span<uint8_t const> expected{{0xdc, 0x27, 0xde}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
...
TEST(DoCanFrameCodecTest, testEncodeFramesWithEnforcedPadding)
{
    ...
    uint8_t consumedDataSize;
    {
        // write a short single frame
        ::etl::span<uint8_t const> data    {{0x12, 0x34, 0x78}};
        ::etl::span<uint8_t const> expected{{0xdc, 0x03, 0x12, 0x34, 0x78, 0x91, 0x91, 0x91}};
        ::etl::span<uint8_t>payload (frame);
        EXPECT_EQ(CodecResult::OK, cut.encodeDataFrame(payload, data, 0U, 0U, consumedDataSize));
        EXPECT_TRUE(::etl::equal(expected, payload));
        EXPECT_EQ(sizeof(data), consumedDataSize);
    }
    {
        ...
        {
            // consecutive frame
            ::etl::span<uint8_t const> expected{{0xdc, 0x21, 0xbc, 0xde, 0x91, 0x91, 0x91, 0x91}};
            ::etl::span<uint8_t> payload(frame);
            EXPECT_EQ(
                CodecResult::OK, cut.encodeDataFrame(payload, data, 1U, 6U, consumedDataSize));
            EXPECT_TRUE(::etl::equal(expected, payload));
    ...
    }
    {
        ...
        longerFrame[0] = 0xdcU;
        ::etl::span<uint8_t const> expected{
    ...
    {
        // write a simple flow control frame
        ::etl::span<uint8_t const> expected{{0xdc, 0x30, 0x13, 0x25, 0x91, 0x91, 0x91, 0x91}};
        ::etl::span<uint8_t> payload(frame);
        EXPECT_EQ(
...
TEST(DoCanFrameCodecTest, testEncodeShortAndLongFramesWithEnforcedPadding)
{
    ...
    }
    {
        ...
        ::etl::span<uint8_t const> data    {{0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde}};
        ::etl::span<uint8_t const> expected{
    ...
    }
    {
        ...
        {
            // consecutive frame
            ::etl::span<uint8_t const> expected{{0xdc, 0x21, 0x8a, 0xac, 0x11, 0x91, 0x91, 0x91}};
            ::etl::span<uint8_t> payload = frame;

...
enum PinId
{
    ...
    // The Waveshare RP2350-ETH Mini has a single onboard LED and no dedicated safety test pin.
    // These IDs exist so that the generic safety console command can be built, and are expected to
    // be wired to external hardware on GP14/GP15.

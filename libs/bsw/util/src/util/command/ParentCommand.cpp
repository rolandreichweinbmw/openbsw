...
::etl::intrusive_forward_list<ICommand, ::etl::forward_link<0>> const& ParentCommand::getCommands() const { return _commands; }
...
ESR_NO_INLINE void ParentCommand::addCommand_local(ICommand& cmd)
{
    ...
    ::etl::intrusive_forward_list<ICommand, ::etl::forward_link<0>>::iterator it = _commands.begin();

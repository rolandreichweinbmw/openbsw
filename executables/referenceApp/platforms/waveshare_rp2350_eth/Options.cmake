...
set(RP2XXX_BOARD waveshare_rp2350_eth)

# The vendored pico-sdk C headers use static_assert, which needs C11.
set(CMAKE_C_STANDARD 11)

# This board has no plain onboard LED, only an addressable RGB LED on GP25, so
# its board header defines PICO_DEFAULT_WS2812_PIN instead of
# PICO_DEFAULT_LED_PIN. The reference application only drives a single digital
# output, so GP25 is used as such here. Driving it as a plain GPIO does not
# produce a defined color on the WS2812; wire an external LED to GP25 to observe
# the output.
add_compile_definitions(PICO_DEFAULT_LED_PIN=25)

set(_WAVESHARE_RP2350_ETH_ARCH_FLAGS
    "-mcpu=cortex-m33 -mthumb -mfloat-abi=hard \
-mfpu=fpv5-sp-d16")

set(CMAKE_ASM_FLAGS "${_WAVESHARE_RP2350_ETH_ARCH_FLAGS} -g -O3")

set(_WAVESHARE_RP2350_ETH_COMMON_FLAGS
    "${_WAVESHARE_RP2350_ETH_ARCH_FLAGS} -g -O3 -fshort-enums \
...
# hosted-only guard.
set(CMAKE_C_FLAGS "${_WAVESHARE_RP2350_ETH_COMMON_FLAGS} -ffreestanding")
set(CMAKE_CXX_FLAGS
    "${_WAVESHARE_RP2350_ETH_COMMON_FLAGS} -fno-rtti -fno-exceptions \
...
set(CMAKE_EXE_LINKER_FLAGS
    "${_WAVESHARE_RP2350_ETH_ARCH_FLAGS} -g -O3 \
